                ...
                <div className="flex gap-4">
                    ...
                    <div className={ `account-badge flex justify-between gap-3` }>
                        ...
                        <div className={ `personal-info flex justify-center items-center gap-2 p-[3px] pr-2 pl-2 rounded-lg ${theme.background.heading}` }>
                            ...
                            <div className={ `name text-md ${theme.color.black}` }>Ahmad</div>
                        ...
                        <div className="popup flex items-end">
                                <div className={ `border-4 content flex justify-between items-start gap-2 p-2 w-full h-[88%] overflow-hidden rounded-lg ${theme.background.heading}` }>
                                    ...
                                    <div className="info flex flex-col justify-between gap-1 basis-1/2 h-full">
                                        <div className={ `name flex flex-col gap-2 text-4xl font-thin ${theme.color.black}` }>
                                            Ahmad
